...
<li data-filter="talk"><span class="news-date">Jun 2026</span><span><span class="news-tag tag-demo">Demo</span> <span style="color:#08306B">Text-to-SQL Evaluation Toolkit</span> accepted at 52nd International Conference on Very Large Data Bases - <a href="https://vldb.org/2026/demonstrations.html" target="_blank">VLDB 2026 Demo Track</a>. Oktie Hassanzadeh (IBM Research)*; Yotam Perlitz (IBM); <strong>Nhan Pham</strong> (IBM); Tanvi Kaple (IBM); Karolina Źróbek (IBM); Long Vu (IBM); Michael Glass (IBM); Dharmashankar Subramanian (IBM); Mohammadreza Pourreza (University of Alberta); Davood Rafiei (University of Alberta)</span></li>
